        ...
        <div class="col-lg-7 col-lg-offset-1">
            ...
            <form:form cssClass="form-horizontal" commandName="user" action="/new_user" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <c:set var="error5"><form:errors path="mot_de_passe"><span style="color:#B94A48" class="help-block">Le mot de passe doit être compris entre 8 et 16 caractères.</span></form:errors></c:set>
