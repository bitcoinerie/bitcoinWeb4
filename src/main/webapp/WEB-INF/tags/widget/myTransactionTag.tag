...
<div>
    ...
    <span class="lead">Emetteur : ${transaction.emetteur.prenom} ${transaction.emetteur.nom} , montant courant: ${transaction.emetteur.montant_compte}</span>
    <br>
    <code>Recepteur : ${transaction.recepteur.prenom} ${transaction.recepteur.nom} , montant courant: ${transaction.recepteur.montant_compte} </code>
